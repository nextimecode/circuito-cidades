...
export type GetDateEventQuery = {
  __typename?: 'Query'
  dateEvents: Array<{ __typename?: 'DateEvent'; id: string; dates: Array<any> }>
}

export type GetEtapasQueryVariables = Exact<{ [key: string]: never }>

export type GetEtapasQuery = {
  __typename?: 'Query'
  etapas: Array<{ __typename?: 'Etapa'; date?: string | null; city: Array<string> }>
}
...
export type GetModalidadesQuery = {
  __typename?: 'Query'
  modalidades: Array<{
    __typename?: 'Modalidade'
    title?: string | null
 ...
 * });
 */
export function useGetDateEventQuery(
  baseOptions?: Apollo.QueryHookOptions<GetDateEventQuery, GetDateEventQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetDateEventQuery, GetDateEventQueryVariables>(
    GetDateEventDocument,
    options
  )
}
export function useGetDateEventLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetDateEventQuery, GetDateEventQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetDateEventQuery, GetDateEventQueryVariables>(
    GetDateEventDocument,
    options
  )
}
...
export type GetDateEventQueryResult = Apollo.QueryResult<
  GetDateEventQuery,
  GetDateEventQueryVariables
>
 ...
 * });
 */
export function useGetEtapasQuery(
  baseOptions?: Apollo.QueryHookOptions<GetEtapasQuery, GetEtapasQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetEtapasQuery, GetEtapasQueryVariables>(GetEtapasDocument, options)
}
export function useGetEtapasLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetEtapasQuery, GetEtapasQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
 ...
 * });
 */
export function useGetModalidadesQuery(
  baseOptions?: Apollo.QueryHookOptions<GetModalidadesQuery, GetModalidadesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetModalidadesQuery, GetModalidadesQueryVariables>(
    GetModalidadesDocument,
    options
  )
}
export function useGetModalidadesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetModalidadesQuery, GetModalidadesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetModalidadesQuery, GetModalidadesQueryVariables>(
    GetModalidadesDocument,
    options
  )
}
...
export type GetModalidadesQueryResult = Apollo.QueryResult<
  GetModalidadesQuery,
  GetModalidadesQueryVariables
>
