    ...
    >
      ...
      <Box as="div" placeContent="center" w={['100%', '50%']} py={[3, 4]}>
        ...
        <Box as="div" display="none">
          Desenvolvedores:
          <Link href="https://github.com/hpmoreira05">Henrique Pozzolini</Link>
          <Link href="https://github.com/lucasFilppe">Lucas Filipe</Link>
          <Link href="https://github.com/marcuslamounier">Marcus Lamounier</Link>
